package cn.carhouse.views.marquee;
...
/**
 * https://github.com/zhuozp/MarqueeRecyclerView
 *
 * @author zhipeng.zhuo
 * @date 2020-03-18
 */
public class MarqueeRecyclerView extends RecyclerView {
    ...
    private long playTime = TIME_AUTO_POLL;
    ...
    static class AutoPollTask implements Runnable {
        ...
        public void run() {
            ...
            if (recyclerView != null && recyclerView.running && recyclerView.canRun) {
                ...
                recyclerView.postDelayed(recyclerView.autoPollTask, recyclerView.playTime);
            }
        }
    }
    ...
    public void start() {
        ...
        if (this.canRun) {
            ...
            running = true;
            postDelayed(autoPollTask, playTime);
        }
    }
